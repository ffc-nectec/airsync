...
public class TextFileReader {
    ...
    TextFileReader(String fileparth) throws FileNotFoundException {
        this(fileparth, true, 2000);
    }

    public TextFileReader(String logfile, boolean realtime) throws FileNotFoundException {
        this(logfile, realtime, 2000);
    }

    TextFileReader(String fileparth, boolean realtime, long delay) throws FileNotFoundException {
        {
